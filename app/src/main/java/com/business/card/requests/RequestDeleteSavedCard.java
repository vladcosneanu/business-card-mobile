...
public class RequestDeleteSavedCard extends AsyncTask<String, Integer, JSONObject> {

    private boolean done = false;
    private MainActivity activity;
    private BusinessCard businessCard;

    public RequestDeleteSavedCard(MainActivity activity, BusinessCard businessCard) {
    ...
    protected JSONObject doInBackground(String... params) {
        ...
        try {
            String url = "http://businesscard.netne.net/api/delete/saved_card.php";
    ...
    protected void onPostExecute(JSONObject json) {
        ...
        if (done) {
            activity.onSavedCardDeleteRequestFinished(json);
        }
    }
}
