...
public class RequestLogin extends AsyncTask<String, Integer, JSONObject> {
    ...
    public RequestLogin(LoginActivity activity, String email, String password) {
    ...
    protected void onPostExecute(JSONObject json) {
        ...
        if (done) {
            activity.onLoginRequestFinished(json);
        }
    }
}