...
public class RequestShareUsers extends AsyncTask<String, Integer, JSONArray> {
    ...
    public RequestShareUsers(MainActivity activity, User user, Coordinate coordinate, String distance) {
    ...
    protected void onPostExecute(JSONArray json) {
        ...
        if (done) {
            activity.onShareUsersRequestFinished(json);
        }
    }
}
